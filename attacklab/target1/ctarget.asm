...
00000000004017c0 <touch1>:
  ...
  4017cb:	00 00 00 
  4017ce:	bf c5 30 40 00       	mov    $0x4030c5,%e
...
0000000000401968 <test>:
  401968:	48 83 ec 08          	sub    $0x8,%rsp        # open stack
  40196c:	b8 00 00 00 00       	mov    $0x0,%eax        # rax = 0
  401971:	e8 32 fe ff ff       	callq  4017a8 <getbuf>  # call getbuf
